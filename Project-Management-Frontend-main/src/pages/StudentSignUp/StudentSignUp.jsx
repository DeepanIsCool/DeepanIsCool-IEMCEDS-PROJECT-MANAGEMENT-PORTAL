...
const StudentSignUp = () => {
  ...
  const handleOTPChangeForEmail = async (event) => {
    ...
    if (value.length === 4) {
      try {
        ...
        // Make API call to verify OTP or perform desired action
        const response = await fetch(
          import.meta.env.VITE_BACKEND_URL+"api/studentsRoutes/signupvalidation/ValidateEmailOTP",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleSendOTPForEmail = async (e) => {
    ...
    try {
      if (email !== "") {
        ...
        const response = await fetch(
          import.meta.env.VITE_BACKEND_URL+"api/studentsRoutes/signup/SendOtpEmail",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleEnrollChange = async (event) => {
    ...
    if (value.length === 14) {
      ...
      try {
        ...
        const response = await fetch(
          import.meta.env.VITE_BACKEND_URL+"api/studentsRoutes/signupvalidation",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const url = import.meta.env.VITE_BACKEND_URL+"api/studentsRoutes/signup";
