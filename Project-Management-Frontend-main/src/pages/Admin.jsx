...
useEffect(() => {
  ...
  fetchFacultyProflie();
          ...
          try {
            const response = await axios.get(import.meta.env.VITE_BACKEND_URL+'api/projectRoutes/getallapplications', {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("access_token")}`
              }
            });
      ...
      useEffect(() => {
        const fetchProjects = async () => {
          try {
            const response = await axios.get(import.meta.env.VITE_BACKEND_URL+'api/projectRoutes/getProjects', {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("access_token")}`
              }
            });
